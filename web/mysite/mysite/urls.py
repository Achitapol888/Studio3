...
urlpatterns = [
    ...
    path('result-receiver/<int:post_id>/', views.search_matches_receiver, name= 'result_receiver'),
    path('verify/', views.verify, name= 'verify'),
    path('logout/', auth_views.LogoutView.as_view(), name='logout'),
    path('edit-profile/', views.edit_profile, name='edit_profile'),
    path('results-giver/<int:post_id>/', views.search_matches_giver, name='results_giver'),
    path('post-history/<int:profile_id>/', views.post_history, name='post_history'),
    ...
    path('delete_confirm1/<int:post_id>/', views.delete_receiver_post, name='delete_confirm1'),
    path('delete_confirm2/<int:post_id>/', views.delete_giver_post, name='delete_confirm2'),
